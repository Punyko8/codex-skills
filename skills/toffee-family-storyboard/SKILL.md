...
description: Toffee Family 分镜头脚本双Agent闭环检验系统。用于 Toffee Family 儿童剧及同类低龄内容的剧本拆分、4–15秒视频生产段设计、对白逐字零删减与慢中快语速核验、场面调度、表演节拍、段内多镜切换、每段4–6格故事板、逐段AI视频提示词、黑白低完成度动画粗草绘制及量化质检，直至评分通过或强制终止。
---
