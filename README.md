...
- `skills/dialogue-diagnosis-zh` — 台词专家：逐句诊断角色辨识度、潜台词、类型语感、节奏和改写理由。
- `skills/script-development-zh` — 剧本开发：七步完成创意收集、方向发散、大纲、审稿和项目档案。
- `skills/script-doctor-roundtable-zh` — 剧本医生圆桌：召集多位行业评委对剧本做证据化会诊和问题归纳。
- `skills/script-writing-zh` — 剧本写作：把项目档案和大纲扩写为标准影视剧本或小说化叙事剧本。
